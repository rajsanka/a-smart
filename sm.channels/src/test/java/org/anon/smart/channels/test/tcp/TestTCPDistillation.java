 ...
 * HEADERS
 * ************************************************************
 * File:                org.anon.smart.channels.test.tcp.TestTCPDistillation
 * Author:              rsankar
 * Revision:            1.0
 * Date:                11-01-2013
 *
...
public class TestTCPDistillation implements Distillation
{
    private boolean _respond;
    private Rectifier _myRectifier;

    public TestTCPDistillation(boolean resp)
    {
        _respond = resp;
    }
