 ...
 * HEADERS
 * ************************************************************
 * File:                org.anon.smart.channels.tcp.TCPClientFactory
 * Author:              rsankarx
 * Revision:            1.0
 * Date:                26-09-2015
 *
...
import org.anon.smart.channels.tcp.netty.TCPClient;

import org.anon.utilities.exception.CtxException;

public class TCPClientFactory implements SCFactory
{
        ...
        throws CtxException
    {
        ...
        return new TCPClient(shell, (TCPConfig)cfg);
    }
}
