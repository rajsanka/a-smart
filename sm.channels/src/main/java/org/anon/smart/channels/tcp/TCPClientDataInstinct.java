 ...
 * HEADERS
 * ************************************************************
 * File:                org.anon.smart.channels.tcp.TCPClientDataInstinct
 * Author:              rsankarx
 * Revision:            1.0
 * Date:                26-09-2015
 *
...
public class TCPClientDataInstinct extends TCPDataInstinct
{
    public TCPClientDataInstinct(Rectifier rect, TCPDataFactory fact)
    {
        super(rect, fact);
    }
}
