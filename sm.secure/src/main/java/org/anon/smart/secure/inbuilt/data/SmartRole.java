...
{
    public class PermittedAccess implements java.io.Serializable
    {
        String permitted;
        String access;
        ...
        public String getPermitted() { return permitted; }
    }
    ...
    public List<PermittedAccess> permittedAccess() { return _accesspermitted; }
}
