 ...
 * HEADERS
 * ************************************************************
 * File:                org.anon.smart.d2cache.store.repository.datasource.metadata.CompiledDelete
 * Author:              rsankarx
 * Revision:            1.0
 * Date:                19-07-2016
 *
...
public class CompiledDelete extends AbstractSQL
{
    CompiledDelete(String tbl)
    {
        super(tbl, DataMetadata.sqltypes.delsql);
    }
