 ...
 * HEADERS
 * ************************************************************
 * File:                org.anon.smart.d2cache.store.repository.datasource.metadata.CompiledInsert
 * Author:              rsankarx
 * Revision:            1.0
 * Date:                19-07-2016
 *
...
public class CompiledInsert extends AbstractSQL
{
    public CompiledInsert(String tbl) 
    {
        super(tbl, DataMetadata.sqltypes.inssql);
    }
