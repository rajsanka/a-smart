 ...
 * HEADERS
 * ************************************************************
 * File:                org.anon.smart.d2cache.store.repository.datasource.metadata.CompiledUpdateWithKey
 * Author:              rsankarx
 * Revision:            1.0
 * Date:                19-07-2016
 *
...
public class CompiledUpdateWithKey extends CompiledUpdate
{
    private String _key;
    public CompiledUpdateWithKey(String tbl) 
    {
        super(tbl, DataMetadata.sqltypes.updkeysql);
    }
    ...
    public void addAttributeFragment(AttributeMetadata meta)
    {
        ...
        if (meta.isKey()) _key = meta.columnName();
    }

    @Override
    protected String postfix()
    {
        String ret = super.postfix();
        ret += " WHERE " + _key + " = ?";
        return ret;
    }
}
