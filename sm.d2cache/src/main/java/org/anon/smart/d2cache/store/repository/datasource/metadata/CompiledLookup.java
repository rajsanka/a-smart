 ...
 * HEADERS
 * ************************************************************
 * File:                org.anon.smart.d2cache.store.repository.datasource.metadata.CompiledLookup
 * Author:              rsankarx
 * Revision:            1.0
 * Date:                19-07-2016
 *
...
public class CompiledLookup extends CompiledSelect
{
    private String _key;

    CompiledLookup(String tbl)
    {
        super(tbl, DataMetadata.sqltypes.lookupsql);
    }
