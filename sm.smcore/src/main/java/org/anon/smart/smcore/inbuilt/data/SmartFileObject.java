 ...
 * HEADERS
 * ************************************************************
 * File:                org.anon.smart.smcore.inbuilt.data.UploadData.java
 * Author:              raooll
 * Revision:            1.0
 * Date:                May 23, 2013
 *
 ...
 * ************************************************************
 * */
package org.anon.smart.smcore.inbuilt.data;
...
public class SmartFileObject implements java.io.Serializable{
	...
	public String _canonicalLocation;
	...
	public String toString() {
		return "SmartFileObject [_keyList=" + _keyList + ", _uploadId="
				...
				//+ ", _group=" + _group + ", _size=" + _size + ", _canonicalLocation=" + _canonicalLocation +"]";
				+ ", _size=" + _size + ", _canonicalLocation=" + _canonicalLocation +"]";
	}
