 ...
 * HEADERS
 * ************************************************************
 * File:                org.anon.smart.smcore.channel.server.RawEventPData
 * Author:              rsankarx
 * Revision:            1.0
 * Date:                27-09-2015
 *
...
public class RawEventPData extends PData
{
    ...
    public RawEventPData(DScope scope, CData data)
    {
        super(scope, data);
        setupFrom(scope);
    }

    public void setupFrom(DScope scope)
    {
        RawEventDScope edscope = (RawEventDScope)scope;
